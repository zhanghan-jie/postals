...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / r"D:\lx\yolov5-master\runs\train\exp16\weights\best.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / r"D:\lx\yolov5-master\data\myVOC.yaml", help="dataset.yaml path")
